   ...
   return (
      <>
         <div className="flex flex-row h-20 w-full bg-white lg:bg-transparent md:bg-white sm:bg-white justify-end items-center">
            <div className="absolute bottom-0 lg:bottom-1 md:bottom-1 sm:bottom-0 left-0 flex justify-center items-center lg:w-18 lg:h-18 w-14 h-14 ml-4 rounded-full bg-neutral-700 border-blue-600">
               avatar
            </div>
